<%@ Page Title="" Language="C#" MasterPageFile="~/AWCTemplate.Master" AutoEventWireup="true" CodeBehind="ShoppingCart.aspx.cs" Inherits="AWCOnlineStore.ShoppingCart" %>
                                        ...
                                        <table height="100%" cellSpacing=0 cellPadding=0 width=550 border=0>
                                            <tr vAlign=top>
                                                <td width=550>
                                                    ...
                                                    <asp:imagebutton id=UpdateBtn runat="server" ImageURL="images/update_cart.gif" 
                                                    ...
                                                    <asp:imagebutton id=CheckoutBtn runat="server" 
                                                        ImageURL="images/final_checkout.gif" onclick="CheckoutBtn_Click"></asp:imagebutton>
                                                    <br>
                                                </td>
                                            </tr>
                                        </table>
